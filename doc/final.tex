...
At our first running of the algorithm, we noticed that the number of registered sphere-sphere collisions was greater than the number of \hyphenation{time-steps}.  This should be impossible, as a sphere-sphere collision should
occur very rarely, depending on the total volume of the space and the number of spheres in the simulation.  Even when the number of spheres was 2, this phenomena occurred.  Upon debugging the simulation with the visualizer,
...
\begin{itemize}
	\item The overhead of spawning multiple threads per \hyphenation{time-step} dwarfs the work done by the update step
